...
<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input id="stock" class="form-control" type="text" name="stock" placeholder="stock" disabled>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group">
    ...
    <div class="col-md-6">
        <a href="#" class="btn btn-primary" id="btn_generar"><i class="fas fa-save"></i> Generar Ventaza</a>
    </div>
